  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center justify-between">
        ...
        {negative && (
          <span className="text-[9px] font-mono text-cfo-red bg-cfo-red/10 px-1.5 py-0.5 rounded">
            outflow
          </span>
        )}
        {hint && (
  ...
  return (
    <div
      className={cn(
        ...
        accent
          ? "bg-cfo-indigo/10 border border-cfo-indigo/20 mt-2"
          : "bg-secondary/40 mt-1",
        large && "py-3",
      )}
    >
      <span
...
export function CashFlowPage() {
  ...
  const netChangeInCash =
    netCashOperating + netCashInvesting + netCashFinancing;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-card border border-border rounded-lg p-5 space-y-3">
          ...
          <NumInput
            ...
            value={data.deprecAmortization}
            onChange={set("deprecAmortization")}
          />
          ...
          <div className="border-t border-border/50 pt-2">
            ...
            <div className="space-y-2 pl-2 border-l border-border/50">
              <NumInput
                ...
                value={data.arChange}
                onChange={set("arChange")}
                negative
                hint="increase = outflow"
              />
              <NumInput
                id="invChange"
                label="Inventory Change"
                value={data.inventoryChange}
                onChange={set("inventoryChange")}
                negative
                hint="increase = outflow"
              />
              <NumInput
                ...
                value={data.apChange}
                onChange={set("apChange")}
                hint="increase = inflow"
              />
              <NumInput
                id="otherOps"
                label="Other Operating"
                value={data.otherOperating}
                onChange={set("otherOperating")}
              />
            </div>
          </div>
        ...
        <div className="bg-card border border-border rounded-lg p-5 space-y-3">
          ...
          <NumInput
            ...
            value={data.purchaseEquipment}
            onChange={set("purchaseEquipment")}
            negative
          />
          <NumInput
            id="saleAssets"
            label="Sale of Assets"
            value={data.saleAssets}
            onChange={set("saleAssets")}
            hint="inflow"
          />
          <NumInput
            id="investments"
            label="Investments Made"
            value={data.investmentsMade}
            onChange={set("investmentsMade")}
            negative
          />
          <NumInput
            id="otherInv"
            label="Other Investing"
            value={data.otherInvesting}
            onChange={set("otherInvesting")}
          />
        ...
        <div className="bg-card border border-border rounded-lg p-5 space-y-3">
          ...
          <NumInput
            ...
            value={data.proceedsLoans}
            onChange={set("proceedsLoans")}
            hint="inflow"
          />
          <NumInput
            id="repayments"
          ...
          <NumInput
            ...
            onChange={set("dividendsPaid")}
            negative
          />
          <NumInput
            id="shareIssue"
            label="Share Issuance"
            value={data.shareIssuance}
            onChange={set("shareIssuance")}
            hint="inflow"
          />
          <NumInput
            id="otherFin"
          ...
          <div className="space-y-2 pt-2">
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  netChangeInCash >= 0 ? "text-cfo-green" : "text-cfo-red",
                )}
              >
                {netChangeInCash < 0
                  ? `(${formatCurrency(Math.abs(netChangeInCash))})`
            ...
            <div
              className={cn(
                ...
                closingCash >= 0
                  ? "border-cfo-indigo/40 bg-cfo-indigo/5"
                  : "border-cfo-red/40 bg-cfo-red/5",
              )}
            >
              <span className="text-sm font-display font-semibold text-foreground uppercase tracking-wider">
              ...
              <span
                className={cn(
                  ...
                  closingCash >= 0 ? "text-cfo-indigo" : "text-cfo-red",
                )}
              >
            ...
            {[
              ...
              <div
                ...
                className={cn(
                  ...
                  bold &&
                    "border-t border-border mt-1 pt-2 font-semibold text-foreground",
                )}
              >
                <span
